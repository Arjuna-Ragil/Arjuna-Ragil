export default function AboutMe() {
  return (
    <>
      ...
      <div className="flex h-full w-full -rotate-6 flex-col justify-center border-1 border-black/20 bg-yellow-200 p-5 shadow-xl duration-500 group-hover:absolute group-hover:translate-[50%] group-hover:scale-110 group-hover:rotate-0 hover:shadow-2xl">
