            ...
            <div className="min-h-screen h-full w-full flex items-center justify-center md:grid grid-cols-2 p-10" id="saturn">
                <div className="flex text-white flex-col gap-5 self-center items-center justify-center bg-gray-400/10 border border-white backdrop-blur-sm rounded-2xl p-10">
                    ...
                    <div className="h-full w-full grid grid-cols-2">
                        <div className="h-30 w-auto aspect-square relative flex items-center justify-center">
                            <Image src={"/project/demoLogo.svg"} alt="Logo" fill/>
                        </div>
                        <div className="h-30 w-auto aspect-video relative flex items-center justify-center">
                            <Image src={"/project/demoDoc.svg"} alt="Logo" fill/>
                        </div>
                    </div>
                    <p className="text-xl text-justify">A web-based platform powered by Gemini AI that helps governments analyze public needs and aspirations.</p>
                ...
                <div className="col-start-2 flex text-white flex-col gap-5 self-center items-center justify-center bg-gray-400/10 border border-white backdrop-blur-sm rounded-2xl p-10">
                    ...
                    <div className="h-1/2 w-full grid grid-cols-2">
                        <div className="h-full w-auto aspect-square relative">
                            <Image src={"/project/planLogo.svg"} alt="Logo" fill/>
                        </div>
                        <div className="h-full w-auto aspect-square relative">
                            <Image src={"/project/planDoc.svg"} alt="Logo" fill/>
                        </div>
                    </div>
                    <p className="text-xl text-justify">A web-based application that leverages AI (Gemini) and real-time spatial data to support urban planning and land-use analysis.</p>
                    <div className="h-full w-full grid md:grid-cols-4 grid-cols-2 gap-3 text-black">
                        {planix.map((tech) => (
                            <div key={tech.name} className="h-full w-full flex flex-col items-center justify-center bg-white/30 rounded-4xl p-3">
                                <div className="h-full w-auto aspect-square relative flex items-center justify-center">
                                    <Image src={tech.image} alt={tech.name} width={50} height={50}/>
        ...
        return(
            <div className="min-h-screen h-full w-full flex items-center justify-center md:grid grid-cols-2 p-10">
                <div className="flex text-white flex-col gap-5 self-center items-center justify-center bg-gray-400/10 border border-white backdrop-blur-sm rounded-2xl p-10">
                    ...
                    <div className="h-1/2 w-full grid grid-cols-2">
                        <div className="h-full w-auto aspect-square relative">
                            <Image src={"/project/ppLogo.svg"} alt="Logo" fill/>
                        </div>
                        <div className="h-full w-auto aspect-square relative">
                            <Image src={"/project/ppDoc.svg"} alt="Logo" fill/>
                        </div>
                    </div>
                    <p className="text-xl text-justify">AI-powered web application that allows users to upload or take a picture of a product and instantly search for its average price across multiple online platforms.</p>
                    <div className="h-full w-full grid md:grid-cols-4 grid-cols-2 gap-3 text-black">
                        {picprice.map((tech) => (
                            <div key={tech.name} className="h-full w-full flex flex-col items-center justify-center bg-white/30 rounded-4xl p-3">
                                {tech.image ?
