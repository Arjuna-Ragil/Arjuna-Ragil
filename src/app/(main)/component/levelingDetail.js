  ...
  if (showDetail !== "Leveling") return
    ...
    return(
        <div className="w-full h-full flex items-center justify-center col-span-2 px-10 animate-dropDown origin-top">
          <div className="h-full w-full justify-center overflow-y-scroll flex flex-col gap-5 bg-blue-400/10 rotate-z-1 -rotate-x-5 -rotate-y-15 scale-y-120 p-5 py-25 text-center text-white">
            ...
            <div className="flex flex-row gap-3 justify-evenly items-center">
              ...
              <Image src={"/project/lvlDoc3.svg"} alt="picprice doc 1" width={150} height={150} className=" border-1 shadow-2xl rounded-3xl"/>
            </div>
